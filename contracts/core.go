...
// FilterRequested is a free log retrieval operation binding the contract event 0x1ec8f6e317dae18a420e22a3cb57fa975f9a2030cbc3ed06dbfed961756f8fb0.
//
// Solidity: event Requested(bytes32 indexed requestId, string dataSource, string selector, address indexed callbackAddr, uint8 aggrType, uint8 precision, uint256 executionTimestamp, uint256 timestamp)
...
// WatchRequested is a free log subscription operation binding the contract event 0x1ec8f6e317dae18a420e22a3cb57fa975f9a2030cbc3ed06dbfed961756f8fb0.
//
// Solidity: event Requested(bytes32 indexed requestId, string dataSource, string selector, address indexed callbackAddr, uint8 aggrType, uint8 precision, uint256 executionTimestamp, uint256 timestamp)
...
// ParseRequested is a log parse operation binding the contract event 0x1ec8f6e317dae18a420e22a3cb57fa975f9a2030cbc3ed06dbfed961756f8fb0.
//
// Solidity: event Requested(bytes32 indexed requestId, string dataSource, string selector, address indexed callbackAddr, uint8 aggrType, uint8 precision, uint256 executionTimestamp, uint256 timestamp)
